...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => $this->get_server_var('DOCUMENT_ROOT').$options["relativePath"],
            'upload_url' => $this->get_domain_url().$options["relativePath"],
            'relative_path' => $this->get_domain_url().$options["relativePath"], //RINA: Added
		...
		*/
                'thumbnail' => array(
                    ...
                    'max_height' => 128 // either specify height, or set to 0. Then height is automatically adjusted - keeping aspect ratio to a specified max_width.
                )
            ),
            'print_response' => true
        );
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file->name = str_replace(".", "", microtime(true)) . "." . $fileExtension;
        $file->relativePath = $this->options['relativePath'] . $file->name; //RINA: Added
        $file->title = $this->get_file_name($uploaded_file, $name, $size, $type, $error,
            $index, $content_range);
        $file->title = str_replace(".".$fileExtension, "", $file->title);
        $file->description = "";
